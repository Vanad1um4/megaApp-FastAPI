...
def db_add_one_transaction(transaction: Transaction, user_id: int) -> bool:
    try:
        with connection.cursor(cursor_factory=DictCursor) as cursor:
            ...
            sql = '''
                INSERT INTO
                    transaction (date, amount, account_id, category_id, kind, is_gift, notes, user_id)
                VALUES
                    (%s, %s, %s, %s, %s, %s, %s, %s);'''
...
def db_add_two_transactions(transaction: Transaction, user_id: int) -> bool:
    try:
        with connection.cursor(cursor_factory=DictCursor) as cursor:
            ...
            sql = '''
                INSERT INTO
                    transaction (date, amount, account_id, category_id, kind, is_gift, notes, user_id, twin_transaction_id)
                VALUES
                    (%s, %s, %s, %s, %s, %s, %s, %s, %s)
                RETURNING
                    id;'''
